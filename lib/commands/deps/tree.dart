...
//     final localDeps = rushYaml.deps?.where((el) => !el.isRemote) ?? [];
...
//       ..resetColorAttributes()
//       ..writeLine(
//           '  This dependency was up/down-graded from version "x" to "y"');
//   }
...
//       final splitted = artifact.spec.split(':');
//       _printGrpArtId(
...
//               .firstWhere((element) => element.spec == el);
//         } catch (_) {
//           try {
